...
class TestSaveGetDelete:
    ...
    def test_save_then_get_round_trips(self) -> None:
        repository = InMemoryDlqRepository()
        entry = _entry()
        repository.save(entry)
        assert repository.get(entry.job_id) is entry
...
class TestListAndCount:
    ...
    def test_list_orders_by_failed_at(self) -> None:
        repository = InMemoryDlqRepository()
    ...
    def test_count_reflects_saved_entries(self) -> None:
        repository = InMemoryDlqRepository()
...
class TestClearAndDunder:
    ...
    def test_clear_empties_repository(self) -> None:
        repository = InMemoryDlqRepository()
        repository.save(_entry())
        repository.clear()
